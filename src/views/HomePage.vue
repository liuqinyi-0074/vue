...
const fetchOpenAIResponse = async () => {
  try {
    const apiKey = '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'; // Ensure this is set in .env file
